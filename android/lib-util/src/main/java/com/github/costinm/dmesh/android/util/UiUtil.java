...
/**
 * Small utils used in various places in UI - for using the raw android APIs.
 * <p>
...
public class UiUtil {
    ...
    public static StringBuilder toString(Bundle b, String delim) {
        ...
        for (String k : b.keySet()) {
            ...
            sb.append(k).append(":").append(o).append(delim);
        }
        return sb;
    }
     ...
     * Needed to show all the items of the ListView
